...
values ('Sales',10000,1),
       ('Marketing',75000,2),
       ('Engineering',125000,3);

insert into employees(first_name, last_name, email, phone_number, salary, department_id)
values ('John','Doe','john.doe@gmail.com','555-123-4567',50000,1),
       ('Jane','Smith','jane.smith@gmail.com','555-234-5678',60000,2),
       ('Alice','Johnson','alice.johnson@gmail.com','555-345-6789',70000,3);
